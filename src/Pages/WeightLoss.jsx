              ...
              <div>
                ...
                <div className="space-y-6 text-amber-900 text-lg leading-relaxed font-light animate-fadeInUp">
                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Embark on a transformative weight loss journey with
                    BodEase's science-backed approach. Our weight management
                    program is designed to deliver sustainable results while
                    supporting your overall health and energy.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Every individual is different, and so are their goals.
                    That’s why our certified nutritionists create personalized
                    meal plans based on your metabolism, lifestyle, food
                    preferences, and health objectives. We focus on building
                    lifelong healthy habits rather than promoting restrictive
                    diets.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Using balanced nutrition, portion control, and smart meal
                    timing, we help you boost your metabolism and achieve steady
                    progress. Thousands have already experienced life-changing
                    results through our proven methods.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    With continuous support, regular monitoring, and timely
                    adjustments, your journey with BodEase is designed to be
