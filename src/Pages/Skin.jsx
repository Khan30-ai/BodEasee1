              ...
              <div>
                ...
                <div className="space-y-6 text-amber-900 text-lg leading-relaxed font-light animate-fadeInUp">
                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Looking after your skin and hair isn’t just about what you
                    apply it’s about what you nourish your body with too. At
                    BodEase, we help you improve your skin and hair health
                    through personalized nutrition and simple daily habits.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Whether you’re dealing with acne, hair fall, dryness, or
                    just want a healthy glow, our team creates easy to follow
                    plans that actually fit into your routine. No extreme diets
                    or complicated products just real food, the right nutrients,
                    and smart choices that make a visible difference.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    We focus on things like hydration, gut health, and nutrient
                    balance to support your skin from the inside out and
                    strengthen your hair naturally. And we’re with you
                    throughout checking in, guiding you, and helping you stay on
                    track.
                  </p>

                  <p className="transform transition-all duration-700 hover:translate-x-2">
                    Healthy skin and hair shouldn’t be complicated. With a
                    little help, you’ll start to feel and see the difference.
                  </p>
                </div>
              </div>
